...
const incidentCategoriesApi = createCrudApi<IncidentCategory>(
  "incident-categories",
);
...
const authApi = {
  ...
  loginGoogle: () => apiClient.get("auth/google/login").then((res) => res.data),
...
const api = {
  users: usersApi,
  incidentCategories: incidentCategoriesApi,
